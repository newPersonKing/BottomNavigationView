...
/**
 * Created by algorithm on 2018/4/10.
 * <p>
 * 三个滚轮 日期 小时 分钟
 */

public class ALTimePicker2Dialog implements DatePickerView.OnSelectMoveListener {
    ...
    public ALTimePicker2Dialog(Context context) {
        mContext = context;
    }

    public ALTimePicker2Dialog Builder() {
...
//        dialogWindow.setAttributes(lp);
    ...
    public ALTimePicker2Dialog setTitleShow(boolean isShow) {
        if (isShow) {
    ...
    private ALTimePicker2Dialog addSheetItem() {
        ...
        mDatePickerView.setSelected(61);
    ...
    public ALTimePicker2Dialog setPositiveClick(OnPositiveClick onPositiveClick) {
